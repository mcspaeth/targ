...
ATTHSW:	
				...
				lda			TIMERA
				bne			ATTHSW									; Inner loop
				
				dec			DELH
				bne			ATTHSL									; Outer loop 
...
DRAWHS:
				...
				;; Add actual HS/initials
				lda			#$00
HSLOOP:
				pha
				ora			#$20										; $20,24 = 1st, 5th 
				jsr			DRAWSTRA

				;; Draw Score
				pla
				pha															; Stash
				asl			a												; a<<1 (2-byte table)
				tax
				inx
				ldy			#$07										; Location 
				jsr			HSBCD										; Draw score
				jsr			HSBCD										; Draw score
				lda			#$30										; 0 
				sta			(SCRLOC), y							; Store byte

				jsr			KILL0										; Erase leading 0s 
